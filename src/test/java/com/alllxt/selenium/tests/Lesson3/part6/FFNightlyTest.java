package com.alllxt.selenium.tests.Lesson3.part6;
 ...
 */
public class FFNightlyTest extends BaseTest {

    private WebDriver driver;
    private WebDriverWait wait;
    private User user = new User();

    private String firefoxNightlyPath = "C:\\Program Files (x86)\\Nightly\\firefox.exe";

    @BeforeClass
    public void setUp() {
        DesiredCapabilities caps = new DesiredCapabilities();
        FirefoxOptions options = new FirefoxOptions();
        options.setBinary(firefoxNightlyPath);
